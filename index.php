...
<html>
	...
	<body>
		...
		<div data-role="footer" data-theme="<?php echo $theme ?>" data-position="fixed">
            <h1>Powered by <a href="http://mobilegrows.com/" rel="external" ><span>MobileGrows</span> </a>|<a href="http://www.sunburstnaples.com/" rel="external"><span> Desktop Site</span></a></h1>
		</div>
		<!-- page 1 ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////-->
		<div data-role="page" id="page1" data-theme="<?php echo $theme ?>">
		  ...
		  <div data-role="main" class="ui-content" data-theme="<?php echo $theme ?>">
				...
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#home" data-transition="<?php echo $transitionefect ?>">Sunburst Cafe</a></div>
				</div>
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#service" data-transition="<?php echo $transitionefect ?>">Sunburst Menu</a></div>
				</div>
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#webcams" data-transition="<?php echo $transitionefect ?>">About Sunburst Cafe</a></div>
				</div>
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#home" data-transition="<?php echo $transitionefect ?>">Reviews & Press on Sunburst Cafe</a></div>
				</div>
              <div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
                  <div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#webcams" data-transition="<?php echo $transitionefect ?>">Sunburst Social </a></div>
              </div>
              <div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
				...
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<section id="navigation-menu-home">
						<ul id="menu-home">
							...
							<li><a href="#webcams" data-transition="<?php echo $transitionefect ?>">Products</a></li>
                            <li><a href="#service" data-transition="<?php echo $transitionefect ?>">Services</a></li>
                            <li><a href="#webcams" data-transition="<?php echo $transitionefect ?>">Photo Gallery</a></li>
                            <li><a href="#service" data-transition="<?php echo $transitionefect ?>">Clients</a></li>
